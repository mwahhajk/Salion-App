        ...
        className="w-full h-full">
          {slides.map((slide,index)=>(
            <SwiperSlide key={index}>
              <div className='w-full h-full bg-center bg-cover relative flex items-center justify-center'
              style={{backgroundImage:`url(${slide.image})`}}>
                ...
                className="relative z-10 text-center text-white px-4 sm:px-8 max-w-3xl">
                  <h1 text-3xl sm:text-5xl font-bold mb-4 uppercase leading-relaxed>{slide.title}</h1>
