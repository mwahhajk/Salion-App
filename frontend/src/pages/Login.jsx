...
function Login() {
  ...
  const{loading,setLoading,navigate,setUser}=useContext(AppContext);
  ...
  return (
    ...
    items-center px-4'>
      <div className='max-w-md w-full bg-white rounded-2xl shadow-2xl p-8 md:p-12'>
        <h1 className='text-4xl md:text-4xl bg-primary text-transparent bg-clip-text text-center mb-2'>Login Now</h1>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <p className='text-gray-600 text-center mt-6'>Don't have an account ? 
